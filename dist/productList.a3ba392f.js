...
})({"l5Nzl":[function(require,module,exports) {
...
const ProductList = ()=>{
    document.getElementById("nav").innerHTML = (0, _navJsDefault.default)(), ((0, _productListSearchJsDefault.default)(), ()=>{
...
},{}],"kNTMn":[function() {},{}],"9umfD":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function Search() {
    ...
    const productsUrl = (0, _apiJs.baseUrl) + "/products";
    ...
    search.addEventListener("keyup", async (e)=>{
        ...
        function displayProducts(products) {
          ...
          <a href="./productDetails.html?id=${product.id}">
            <div class="products-content">
              <div class="products-img" style="background-image: url(${0, _apiJs.baseUrl}${product.image.formats.medium.url});"></div>
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["l5Nzl","03dSc"], "03dSc", "parcelRequire2efc")
