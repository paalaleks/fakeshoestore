...
})({"kNbW3":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = null;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d6ea1d42532a7575";
module.bundle.HMR_BUNDLE_ID = "c986c443c8bf207f";
"use strict";
...
},{}],"32Y13":[function(require,module,exports) {
...
//////////////////////
const index = ()=>{
    document.getElementById("nav").innerHTML = (0, _navJsDefault.default)(), (0, _indexSearchJsDefault.default)(), (()=>{
        document.getElementById("cart").innerHTML = (0, _cartIconJsDefault.default)();
    })();
    document.getElementById("header").innerHTML = (0, _headerJsDefault.default)();
    document.getElementById("featured").innerHTML = (0, _featuredJsDefault.default)();
    document.getElementById("footer").innerHTML = (0, _footerJsDefault.default)();
};
// init index
index();

},{"../styles/global.scss":"2L5oL","../components/nav.js":"kuKN0","../components/cartIcon.js":"23I5l","../components/nav.scss":"kNTMn","../components/header.js":"gMwGB","../components/header.scss":"g0DQ0","../components/featured.js":"a9kDS","../components/footer.js":"4psvf","../components/footer.scss":"jlP4C","../js/search/indexSearch.js":"fh0Du","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"2L5oL":[function() {},{}],"23I5l":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
},{}],"kNTMn":[function() {},{}],"gMwGB":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const Header = async ()=>{
    try {
        const response = await fetch(`${(0, _apiJs.baseUrl)}/shoe-hero?populate=*`);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"g0DQ0":[function() {},{}],"a9kDS":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _apiJs = require("../js/api/api.js");
...
const Featured = async ()=>{
    try {
        const response = await fetch(`${(0, _apiJs.baseUrl)}/shoes?populate=*`);
        const json = await response.json();
        productsList.innerHTML = "";
        json.data.forEach((product, i)=>{
            if (i <= 2) productsList.innerHTML += `
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jlP4C":[function() {},{}],"fh0Du":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
function Search() {
    ...
    const productsUrl = (0, _apiJs.baseUrl) + "/shoes?populate=*";
...
},{"../api/api.js":"OFlXG","../../components/header.js":"gMwGB","../../components/featured.js":"a9kDS","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["kNbW3","32Y13"], "32Y13", "parcelRequire2efc")
