...
})({"hQxu8":[function(require,module,exports) {
...
const productDetails = ()=>{
    document.getElementById("nav").innerHTML = (0, _navJsDefault.default)(), (0, _productDetailsSearchJsDefault.default)(), (()=>{
    ...
    document.getElementById("details").innerHTML = (0, _detailsJsDefault.default)();
...
const Details = async ()=>{
    ...
    try {
        const response = await fetch(`${(0, _apiJs.baseUrl)}/shoes/${id}?populate=image`);
        const json = await response.json();
        products.innerHTML = `
...
function storeLocally(imageUrl, title, textContent, price, id) {
    const cartList = (0, _localstorageJs.getFromStorage)("inCart");
    document.getElementById("buyBtn").addEventListener("click", ()=>{
        ...
        (0, _localstorageJs.saveToStorage)("inCart", cartList);
    });
}
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["hQxu8","9Fena"], "9Fena", "parcelRequire2efc")
