...
})({"7hEpD":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"kNTMn":[function() {},{}],"gMwGB":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
const Header = async ()=>{
    try {
        const response = await fetch(`${_apiJs.baseUrl}/shoe-hero?populate=*`);
